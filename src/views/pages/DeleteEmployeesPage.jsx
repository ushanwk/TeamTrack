export function DeleteEmployeesPage() {
    return (
        <div className='className="w-full px-[130px] py-[50px] flex-col justify-center max-sm:px-[10px]'>
              <h1 className="font-bold text-2xl">Delete Employees</h1>
              ...
              <div class="max-w-4xl mx-auto font-[sans-serif] p-6">
                    <form>
                       <div class="grid sm:grid-cols-2 gap-8">
                            ...
                            <div class="!mt-7">
                                 <button type="button" class="py-3.5 px-7 text-sm font-semibold tracking-wider rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none">
                                      Delete Employee
                                 </button>
                            </div>
                       </div>
